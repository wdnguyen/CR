...
# ggsave(file = "unbracketed.svg", plot = unbracketed_plot, width = 12, height = 8)
# ggsave(file = "bracketed.svg", plot = bracketed_plot, width = 12, height = 8)
# ggsave(file = "u_production_plot.svg", plot = u_production_plot, width = 12, height = 8)
# ggsave(file = "u_removal_plot.svg", plot = u_removal_plot, width = 12, height = 8)
# ggsave(file = "neutral_plot.svg", plot = neutral_plot, width = 12, height = 8)

ggsave(file = "unbracketed.png", plot = unbracketed_plot, width = 12, height = 8, dpi = 300)
ggsave(file = "bracketed.png", plot = bracketed_plot, width = 12, height = 8, dpi = 300)
ggsave(file = "u_production_plot.png", plot = u_production_plot, width = 12, height = 8, dpi = 300)
ggsave(file = "u_removal_plot.png", plot = u_removal_plot, width = 12, height = 8, dpi = 300)
ggsave(file = "neutral_plot.png", plot = neutral_plot, width = 12, height = 8, dpi = 300)
