...
conservative_plot <- ggplot(conservative, aes(x=Site, y=Concentration, fill=Site)) + 
  ...
  theme(strip.text = element_text(size = 24, family = 'sans'),
        ...
        axis.text.x = element_text(size = 18, family = 'sans', colour = 'black'),
...
ggsave(file = "conservative_2018.pdf", plot = conservative_plot, width = 10.25, height = 4, dpi = 600)
ggsave(file = "stable_2018.pdf", plot = stable_plot, width = 10.25, height = 4, dpi = 600)
ggsave(file = "bases_plot_2018.pdf", plot = bases_plot, width = 17, height = 4, dpi = 600)
ggsave(file = "nutrients_plot_2018.pdf", plot = nutrients_plot, width = 26, height = 4, dpi = 600)
ggsave(file = "redox_plot_2018.pdf", plot = redox_plot, width = 10.25, height = 4, dpi = 600)
ggsave(file = "redox2_plot_2018.pdf", plot = redox2_plot, width = 10.5, height = 4, dpi = 600)
```
