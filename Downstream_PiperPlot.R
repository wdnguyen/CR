...
up_costarica <- read.csv("downstream_forpiper.csv")
...
setPDF("downstream_piper1", layout="portrait")
# setPNG("downstream_piper1", width=10, height=10)
...
AA.pl <- with(PD, piperPlot(Ca.meq, Mg.meq, Na.meq,
                            ...
                            xAn.title = "Chloride",
                            yAn.title = "Nitrate"))
addExplanation(AA.pl, where="ul", title="Downstream")
